...
exports.main = async (context, sendResponse) => {
  ...
  // const endpoint__getFollowerCount = `/crm/v3/objects/2-4293954/${topicId}?properties=follower_count&hapikey=${API_KEY}`;
  ...
  // const endpoint__readAssoc = `/crm/v3/objects/0-1/${contactId}/associations/2-4293954/?hapikey=${API_KEY}`;
  ...
  if ( readAssocFilteredResults.length <= 0 ) {
    ...
    // const endpoint_assocFollower = `/crm/v4/objects/0-1/${contactId}/associations/2-4293954/${topicId}?hapikey=${API_KEY}`;
    ...
    // update topic object
    // const endpoint__updateTopic = `/crm/v3/objects/2-4293954/${topicId}?hapikey=${API_KEY}`;
    ...
    // const endpoint_deleteAssocFollower = `/crm/v3/objects/0-1/${contactId}/associations/2-4293954/${topicId}/${associationType}?hapikey=${API_KEY}`;
